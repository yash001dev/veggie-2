...
function PrivacyPolicy() {
  return (
    <div>
      ...
      <p>
        Daxesh Italiya built the Veggi365 app as a Free app. This SERVICE is
        provided by Daxesh Italiya at no cost and is intended for use as is.
        ...
        Conditions, which is accessible at Veggi365 unless otherwise defined in
        this Privacy Policy.{" "}
      </p>
      ...
      <p>
        ...
        but not limited to Contact Number, Email. The information that I request
      ...
      <ul>
        <li>Google Play Services</li> <li>Google Analytics for Firebase</li>{" "}
      ...
      <p>
        ...
        is effective as of 2021-08-28
      </p>
      <h1>Contact Us</h1>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at dcreationcompanay@gmail.com.
      </p>
    </div>
  );
}
